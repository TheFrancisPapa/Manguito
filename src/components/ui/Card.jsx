...
export function Card({ children, className = '', onClick }) {
  const clickable = onClick
    ? 'cursor-pointer hover:border-zinc-200 dark:hover:border-zinc-600 transition-colors'
    : ''
...
// Header reutilizable dentro de una Card
  ...
  return (
    <div className="flex items-start justify-between mb-3">
      <div>
        ...
        {subtitulo && (
          <p className="text-xl font-semibold mt-0.5">{subtitulo}</p>
        )}
      </div>
