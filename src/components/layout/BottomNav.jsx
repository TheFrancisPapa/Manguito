...
const IconBot = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
    <rect x="2" y="7" width="20" height="14" rx="3" fill="currentColor" fillOpacity={0.2} />
...
export function BottomNav() {
  ...
  return (
    ...
    >
      {/* Separator */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-zinc-200/80 dark:via-zinc-700/60 to-transparent" />

      <div className="glass dark:glass-dark flex items-center justify-around h-16 px-1">
        {LINKS.map(({ a, label, Icon, central }) => {
              ...
              <Link key={a} to={a} className="relative -top-5 flex-shrink-0">
                <div
                  ...
                  style={{
                    ...
                    boxShadow: '0 6px 20px rgba(245,166,35,0.50)',
                  }}
                >
                ...
                <p className="text-[10px] text-center mt-1.5 font-bold text-[var(--mango-dark)] dark:text-[var(--mango)]">
                  {label}
                </p>
              </Link>
            )
          ...
          return (
            ...
            >
              ...
              {activo && (
                <span className="absolute bottom-2 w-1 h-1 rounded-full bg-[var(--mango)]" />
              )}
            </Link>
          )
        })}
