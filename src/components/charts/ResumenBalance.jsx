...
// Tres tarjetas: ingresos · gastos · saldo neto
// Usada en el Dashboard como primer widget visible.
  ...
  if (cargando) {
    return (
      <div className="grid grid-cols-3 gap-3">
        {[0, 1, 2].map(i => (
          <div key={i} className="bg-zinc-100 dark:bg-zinc-800 rounded-2xl h-20 animate-pulse" />
        ))}
      </div>
    )
  }
  ...
  return (
    <div className="grid grid-cols-3 gap-3">
      ...
      <div className="bg-red-50 dark:bg-red-900/20 rounded-2xl p-3">
        ...
        <p className="text-base font-semibold text-red-700 dark:text-red-300 truncate">
          {fmt(balance?.total_gastos)}
        </p>
      </div>
