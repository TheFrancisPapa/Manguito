        ...
        <div className="text-center lg:text-left max-w-lg mt-10 lg:mt-0">
          <div className="inline-flex items-center justify-center lg:justify-start gap-3 mb-6">
            <div className="relative">
              ...
              <img src="/Mango.jpg" alt="Logo Manguito" className="relative w-14 h-14 lg:w-16 lg:h-16 rounded-2xl object-cover shadow-md border-2 border-white dark:border-zinc-800" />
            </div>
