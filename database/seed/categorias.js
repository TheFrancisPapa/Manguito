...
export async function seedMovimientos(supabase, usuarioId, catMap) {
  const rows = [
    ...
    // ALIMENTACIÓN (distribuida en 4 semanas)
    ...
    // EDUCACIÓN Y ROPA
    { tipo: 'gasto', monto: 35000, descripcion: 'Curso online Excel', fecha: hace(21), categoria_id: catMap['Educación'] },
...
export async function seedMetas(supabase, usuarioId) {
  ...
  const rows = [
    // 80% — casi lista, barra verde larga
    {
      nombre: 'Fondo de emergencia',
      descripcion: '3 meses de gastos cubiertos',
      monto_objetivo: 900000,
      monto_actual: 720000,
      fecha_limite: null,
      icono: '🛡️', color: '#10B981',
      estado: 'activa', prioridad: 1,
    },
    // 35% — a la mitad, con fecha límite
    {
      nombre: 'Vacaciones en Bariloche',
      descripcion: 'Viaje de 10 días en julio',
      monto_objetivo: 600000,
      monto_actual: 210000,
      fecha_limite: `${anio}-07-01`,
      icono: '✈️', color: '#3B82F6',
      estado: 'activa', prioridad: 2,
    },
    // 5% — recién arrancando
    {
      nombre: 'Notebook nueva',
      descripcion: 'MacBook Air M3',
      monto_objetivo: 1800000,
      monto_actual: 90000,
      fecha_limite: null,
      icono: '💻', color: '#8B5CF6',
      estado: 'activa', prioridad: 3,
    },
  ].map(r => ({ ...r, usuario_id: usuarioId }))
